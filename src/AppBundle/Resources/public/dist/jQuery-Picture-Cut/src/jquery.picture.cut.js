...
(function($) {
    var methods = {
        ...
        init: function(Options) {
            var OptionsIfEmpty = {
                ActionToSubmitUpload: "../jQuery-Picture-Cut/src/php/upload.php",
                ActionToSubmitCrop: "../jQuery-Picture-Cut/src/php/crop.php",
                DefaultImageButton: "../jQuery-Picture-Cut/src/img/icon_add_image2.png"
            };
            var defaults = {
            ...
            return this.each(function() {
                var Elemento;
                var CropWindowStyle = {
                    "jqueryui": "../jQuery-Picture-Cut/src/windows/window.jqueryui.php",
                    "popstyle": "../jQuery-Picture-Cut/src/windows/window.popstyle.php",
                    "bootstrap": "../jQuery-Picture-Cut/src/windows/window.bootstrap.php"
                };
                var $EnableButton;
